...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/web/images/logo-32x32.png') }}" sizes="32x32" />
    <link rel="icon" href="{{ asset('assets/web/images/logo-192x192.png') }}" sizes="192x192" />
...
<body class="v-dark bg-dots dsn-ajax">
    ...
    <script src="{{ asset('assets/web/js/plugins/dsn-grid.min.js') }}"></script>
    <script src="{{ asset('assets/web/js/smooth-scroll.js') }}"></script>
