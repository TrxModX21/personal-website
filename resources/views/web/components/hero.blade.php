<header class="p-relative header-personal d-grid grid-md-2 d-grid-no-space">
    <div class="p-relative box-img ">
        <div class="img-box-parallax before-z-index " data-dsn-triggerhook="top" data-dsn-grid="move-up" data-overlay="4">
            <img src="{{ asset('assets/web/images/head-personal.jpg') }}" class=" cover-bg-img has-direction"
                alt='' />
        </div>
    ...
    <div class="box-content box-padding d-flex align-items-center">
        <div class="box-content-inner">
            ...
            <div class="dsn-def-btn dsn-hover-icon dsn-icon-heading-color mt-30">
                <a class="dsn-btn background-section move-circle has-icon-left" href="about.html" data-dsn="parallax">
