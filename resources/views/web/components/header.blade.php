<header id="site_menu_header" class="site-header  dsn-container d-none dsn-hamburger">
    <div class="main-logo">
        <a href="index.html" data-dsn-text="Blackdsn" class="custom-logo-link main-brand effect-ajax"
            rel="home" aria-current="page">
            <img src="{{ asset('assets/web/images/logo-light.png') }}" class="custom-logo logo-light"
                alt="Blackdsn" />
            <img src="{{ asset('assets/web/images/logo.png') }}" class="custom-logo logo-dark" alt="Blackdsn" />
        </a>
    </div>
